...
Текущий `sample.pdf` создан ReportLab 4.4.9 со встроенным поднабором DejaVu Sans. [Описание происхождения](fixtures/uploads/sample-pdf-provenance.json) фиксирует SHA-256 PDF и шрифта, генератор и две учебные строки; [лицензия DejaVu](fixtures/uploads/licenses/dejavu-fonts.txt) приложена отдельно. SHA-256 PDF: `0472c4e85e36d6cdd1b841187edbcd6b1f0fb98de4e6d2ed580c4d349ba7b87e`. Этот шрифт относится к образцу документа; шрифты интерфейса перечислены выше.
...
- [ReportLab](https://www.reportlab.com/) 4.4.9 — создание поставляемого учебного PDF, версия записана в [provenance](fixtures/uploads/sample-pdf-provenance.json). Лицензия BSD; текст и метаданные лицензии поставляются с пакетом генератора. ReportLab используется при подготовке образца и не входит в зависимости запуска приложения.
